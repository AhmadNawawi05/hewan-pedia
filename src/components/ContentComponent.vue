...
<section class="bg-left bg-no-repeat bg-[url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/ff846d4e-6828-4ef9-9b1f-7f01b3fcf7e6/dfe6foe-feaa6184-f740-4ee8-a508-85ab62ce9c51.png/v1/fill/w_553,h_451/teletubbies_noo_noo_png_clipart_2_by_purpletinkywinky_dfe6foe-fullview.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3mg_PSjdCLLBwF5ZDl5rLcI85G5qAy8QsqiwBAG1wZE')] bg-gray-200 bg-blend-multiply">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <h1 class="mb-4 text-right text-4xl font-bold tracking-tight leading-none text-gray md:text-5xl lg:text-6xl">Noo Noo</h1>
        <p class="mb-3 text-right text-gray-1000 dark:text-gray-400 ">Noo Noo adalah sebuah vacoom cleaner yang menjelma sebagai seekor anjing yang selalu menemani <br> para tubbies, Noo Noo jarang berinterkasi, Noo Noo hanya senang mengelilingi gua dan menghisap lantai</p>
        <br>
        <p class="mb-3 text-right text-gray-1000 dark:text-gray-400 " >Cara merawat Noo Noo sama seperti merawat vacoom cleaner biasa </p>
        <br>
        <p class="mb-3 text-right text-gray-1000 dark:text-gray-400 " >Nyatanya Noo Noo hanyalah vacoom cleaner jadi kalian bisa mendapatkan nya di toko elektronik terdekat </p>
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
...
<!-- <section class="bg-white dark:bg-white-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div class="bg-white-50 dark:bg-white-800 dark:border-white-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <div id="default-carousel" class="relative w-full" align="center" data-carousel="slide">
    
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://d2xjmi1k71iy2m.cloudfront.net/dairyfarm/id/pageImages/desain-perabotan-untuk-rumah.jpeg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
 ...
 <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="rounded-t-lg" src="https://d2xjmi1k71iy2m.cloudfront.net/dairyfarm/id/pageImages/desain-perabotan-untuk-rumah.jpeg" alt="" />
    </a>
    <div class="p-5">
        <a href="#">
...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="p-8 rounded-t-lg" src="https://d2xjmi1k71iy2m.cloudfront.net/dairyfarm/id/pageImages/desain-perabotan-untuk-rumah.jpeg" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
